...
def describe_project():
    ...
    def describe_put():
        ...
        def it_returns_an_error_when_no_metrics_specified(client):
            ...
            expect(status) == 400
            expect(data) == {"message": "No metrics provided."}
    ...
    def describe_delete():
        ...
        def it_allows_metrics_to_decrease(client, project2):
            ...
            expect(status) == 202
            expect(data) == {"message": "Reset minimum metrics."}
...
def describe_project_branch():
    ...
    def describe_get():
        ...
        def it_returns_an_error_for_unknown_projects(client):
            ...
            expect(status) == 404
            expect(data) == {"message": "No such project or branch."}
    ...
    def describe_put():
        ...
        def it_updates_metrics(client, project2):
            status, data = load(
                client.put("/my_owner/my_repo/my_branch", data={"integration": 42})
            )
